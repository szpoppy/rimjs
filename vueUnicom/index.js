...
var VueUnicom = /** @class */ (function () {
    ...
    // 订阅消息
    VueUnicom.prototype.on = function (type, fun) {
    ...
    // 移除订阅
    VueUnicom.prototype.off = function (type, fun) {
    ...
    // 触发订阅
    VueUnicom.prototype.emit = function (query) {
        var _this = this;
        var args = [];
...
function vueUnicomInstall(vue, _a) {
    var _b, _c;
