...
// eslint-disable-next-line
export function mac_hex(key: string, data: string) {
    return binl2hex(core_hmac_md5(key, data))
}
// eslint-disable-next-line
export function mac_b64(key: string, data: string) {
    return binl2b64(core_hmac_md5(key, data))
}
// eslint-disable-next-line
export function mac_str(key: string, data: string) {
...
// eslint-disable-next-line
export default function utf8_hex(s: string) {
    return hex(md5_Utf8Encode(s))
}
// eslint-disable-next-line
export function utf8_b64(s: string) {
    return b64(md5_Utf8Encode(s))
}
// eslint-disable-next-line
export function utf8_str(s: string) {
    return str(md5_Utf8Encode(s))
}
